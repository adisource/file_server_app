...
barang AS b, pesan AS p,user AS u WHERE p.id = u.id AND p.id_barang=b.id_barang  AND  p.id='$id_user' AND p.id_suplayer='$id_sup' and p.status=0 order BY id_order DESC" ;
